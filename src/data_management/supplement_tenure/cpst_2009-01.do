capture log close
log using cpsjan09.log, replace
set mem 500m
...
local dat_name "/homes/data/cps/cpsjan09.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "cpsjan2009.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "cpsjan09.dct"
...
note: by Jean Roth, jroth@nber.org Wed Sep 29 13:17:24 EDT 2010
...
label define hes1l
	...
	-9          "No Response"
;
label values hes1b    hes1b;
label define hes1b
	1           "The adults have shared finances"
	2           "The adults have some shared"
	3           "The adults have separate"
	4           "I am the only adult in the"
	-1          "Not in Universe"
	-2          "Don't know"
	-3          "Refused"
	-9          "No Response"
;
label values hes2     hes2l;
label define hes2l
	1           "A lot"
	2           "Some"
	3           "Not at All"
...
label define hes5l
	...
	-9          "No Response"
;
label values hes6     hes6l;
label define hes6l
	1           "I closed the account"
	2           "The bank closed the account"
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
	-9          "No Response"
;
label values hes7a1   hes7a1l;
label define hes7a1l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
	-2          "Don’t know"
	...
	-9          "No Response"
;
label values hes7a2   hes7a2l;
label define hes7a2l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7a3   hes7a3l;
label define hes7a3l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7a4   hes7a4l;
label define hes7a4l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7a5   hes7a5l;
label define hes7a5l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7a6   hes7a6l;
label define hes7a6l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7a7   hes7a7l;
label define hes7a7l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8a    hes8a;
label define hes8a
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
	...
	-9          "No Response"
;
label values hes8a2   hes8a2l;
label define hes8a2l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8a3   hes8a3l;
label define hes8a3l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8a4   hes8a4l;
label define hes8a4l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8a5   hes8a5l;
label define hes8a5l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8a6   hes8a6l;
label define hes8a6l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8a7   hes8a7l;
label define hes8a7l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9a1   hes9a1l;
label define hes9a1l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
	-2          "Don’t know"
	...
	-9          "No Response"
;
label values hes9a2   hes9a2l;
label define hes9a2l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9a3   hes9a3l;
label define hes9a3l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9a4   hes9a4l;
label define hes9a4l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9a5   hes9a5l;
label define hes9a5l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9a6   hes9a6l;
label define hes9a6l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes10a   hes10a;
label define hes10a
	1           "The bank had inconvenient hours"
	2           "The bank was too far from home"
	3           "There was a language barrier at"
	4           "Didn't trust banks"
	5           "The bank did not feel welcoming"
	6           "The minimum balance requirement"
	7           "The service charges of the bank"
	8           "Did not have enough money to"
	9           "Bounced too many checks or had"
	10          "Banks took too long to clear"
	11          "Did not write enough checks to"
	12          "Could not manage or balance my"
	13          "Did not need or want a bank"
	14          "The bank did not offer needed"
	15          "Specify write-in"
	16          "None of these"
	17          "Could not pick a single reason"
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
	-9          "No Response"
;
label values hes7b1   hes7b1l;
label define hes7b1l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
	-2          "Don't know"
	...
	-9          "No Response"
;
label values hes7b2   hes7b2l;
label define hes7b2l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7b3   hes7b3l;
label define hes7b3l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7b4   hes7b4l;
label define hes7b4l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7b5   hes7b5l;
label define hes7b5l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7b6   hes7b6l;
label define hes7b6l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes7b7   hes7b7l;
label define hes7b7l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b1   hes8b1l;
label define hes8b1l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
	-2          "Don't know"
	...
	-9          "No Response"
;
label values hes8b2   hes8b2l;
label define hes8b2l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b3   hes8b3l;
label define hes8b3l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b4   hes8b4l;
label define hes8b4l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b5   hes8b5l;
label define hes8b5l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b6   hes8b6l;
label define hes8b6l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b7   hes8b7l;
label define hes8b7l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes8b8   hes8b8l;
label define hes8b8l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b1   hes9b1l;
label define hes9b1l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
	-2          "Don't know"
	...
	-9          "No Response"
;
label values hes9b2   hes9b2l;
label define hes9b2l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b3   hes9b3l;
label define hes9b3l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b4   hes9b4l;
label define hes9b4l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b5   hes9b5l;
label define hes9b5l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b6   hes9b6l;
label define hes9b6l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b7   hes9b7l;
label define hes9b7l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes9b8   hes9b8l;
label define hes9b8l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
;
label values hes10b   hes10b;
label define hes10b
	1           "The banks have inconvenient"
	2           "There is no bank near home or"
	3           "There are language barriers at"
	4           "Do not trust banks"
	5           "Banks do not feel comfortable"
	6           "The minimum balance requirement"
	7           "The service charges of bank"
	8           "Do not have enough money to"
	9           "Do not write enough checks to"
	10          "Could not manage or balance a"
	11          "Do not have the proper documents"
	12          "Do not know how to open a bank"
	13          "Banks do not offer needed basic"
	14          "Credit problems"
	15          "Do not see the value of having"
	16          "Bounced too many checks or had"
	17          "Banks take too long to clear"
	18          "Specify write-in"
	19          "None of these"
	20          "Could not pick a single reason"
	-1          "Not in Universe"
	-2          "Don't know"
	-3          "Refused"
	-9          "No Response"
;
label values hes11    hes11l;
label define hes11l
	1           "Very likely"
	2           "Somewhat likely"
	3           "Not too likely"
	...
	-9          "No Response"
;
label values hes12    hes12l;
label define hes12l
	1           "To secure your money"
	2           "To be able to write checks and"
	3           "To be able to apply for a loan"
	4           "To save money for the future"
	5           "To take advantage of direct"
	6           "To send money to family and"
	7           "Other (Specify)"
	-1          "Not in Universe"
	-2          "Don't know"
	-3          "Refused"
	-9          "No Response"
;
label values hes13    hes13l;
label define hes13l
	1           "Within the next year"
	2           "A year or more from now"
	-1          "Not in Universe"
	-2          "Don't know"
	-3          "Refused"
	-9          "No Response"
;
label values hes14    hes14l;
label define hes14l
	1           "Yes"
	2           "No"
	-1          "Not in Universe"
...
label define hes15l
	...
	-9          "No Response"
;
label values hes16    hes16l;
label define hes16l
	1           "Don't have a bank account"
	2           "To get money faster"
	3           "The place is more convenient"
	4           "A bank charges more to cash"
	5           "The place to cash checks asks"
	6           "Feel more comfortable than at"
	7           "Other (Specify)"
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
...
label define hes18l
	...
	-9          "No Response"
;
label values hes19    hes19l;
label define hes19l
	1           "Banks do not sell money orders"
	2           "The place to purchase money"
	3           "Banks charge more for money"
	4           "The place feels more comfortable"
	5           "Other (Specify)"
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
	-9          "No Response"
;
label values hes20    hes20l;
label define hes20l
	1           "Yes"
	2           "No"
	3           "I haven't but I'm unsure about"
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
	-9          "No Response"
;
label values hts21    hts21l;
label define hts21l
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
	-9          "No Response"
;
label values hes22    hes22l;
label define hes22l
	1           "The payday loan service is more"
	2           "It is easier to get a payday loan"
	3           "A payday loan service feels more"
...
label define hes24l
	...
	-9          "No Response"
;
label values hes25    hes25l;
label define hes25l
	1           "Banks don't have small loans"
	2           "The pawn shop service is more"
	3           "It is easier to get money from"
	4           "More comfortable at a pawn shop"
...
label define hes28l
	...
	-9          "No Response"
;
label values hes29    hes29l;
label define hes29l
	1           "To make up for lost income"
	2           "For basic living expenses"
	3           "For house repairs or to buy an"
	4           "For medical expenses"
	5           "For car repairs"
	6           "For school or childcare expenses"
	7           "For special gifts or luxuries"
	8           "Other (Specify)"
	-1          "Not in Universe"
	-2          "Don’t know"
	-3          "Refused"
...
label define hes31l
	...
	-9          "No Response"
;
label values hrsupint hrsupint;
label define hrsupint
	1           "Interview"
	2           "Noninterview"
;
