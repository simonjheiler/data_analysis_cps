log using cpsjan02, text replace
set mem 1000m

/*------------------------------------------------
  by Jean Roth Mon Mar 20 14:20:01 EST 2006
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsjan02
----------------------------------------------- */
...
local dat_name "/homes/data/cps/cpsjan02.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "./cpsjan02.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "./cpsjan02.dct"
...
label define prsd2occ
	...
	34          "Construction trades"
	35          "Other precision prod., craft,"
	36          "Machine opertrs and tenders,"
	37          "Fabricatrs,assemblrs,inspectrs,"
	38          "Motor vehicle operators"
	39          "Other transp. & material"
	40          "Construction laborers"
	41          "Freight, stock & materials"
...
label define prsupsat
	...
	2           "Interview - Interviews had"
	3           "Noninterview - Cases that"
;
label values prtensat prtensat;
label define prtensat
	1           "Not Eligible for Job Tenure"
