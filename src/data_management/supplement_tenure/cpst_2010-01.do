capture log close
log using cpsjan10.log, replace
set mem 500m

/*------------------------------------------------
  by Jean Roth Wed Nov  3 14:16:47 EDT 2010
  Please report errors to jroth@nber.org
  NOTE:  This program is distributed under the GNU GPL.
  See end of this file and http://www.gnu.org/licenses/ for details.
  Run with do cpsjan10
----------------------------------------------- */
...
local dat_name "/homes/data/cps/cpsjan10.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "cpsjan2010.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "cpsjan10.dct"
...
note: by Jean Roth, jroth@nber.org Wed Nov  3 14:16:47 EDT 2010
...
label define pesd2l
	1           "Plant or company closed down or"
	2           "Insufficient work"
