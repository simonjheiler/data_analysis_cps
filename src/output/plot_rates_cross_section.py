...
def _plot_line_charts(
    ...
    ylabels = {
        ...
        "j2j_same_employer_same_occupation_rate": "job-to-job transition: same employer, same occupation",
        "j2j_same_employer_different_occupation_rate": "job-to-job transition: same employer, different occupation",
        "j2j_different_employer_same_occupation_rate": "job-to-job transition: different employer, same occupation",
        "j2j_different_employer_different_occupation_rate": "job-to-job transition: different employer, different occupation",
        ...
        "j2j_same_employer_same_occupation_weighted_rate": "job-to-job transition: same employer, same occupation",
        "j2j_same_employer_different_occupation_weighted_rate": "job-to-job transition: same employer, different occupation",
        "j2j_different_employer_same_occupation_weighted_rate": "job-to-job transition: different employer, same occupation",
        "j2j_different_employer_different_occupation_weighted_rate": "job-to-job transition: different employer, different occupation",
    }
    ...
    ylims = {
        ...
        "j2j_same_employer_same_occupation_rate": [0.0, 1.0, 0.2],
        "j2j_same_employer_different_occupation_rate": [0.0, 0.05, 0.01],
        "j2j_different_employer_same_occupation_rate": [0.0, 0.05, 0.01],
        "j2j_different_employer_different_occupation_rate": [0.0, 0.05, 0.01],
        ...
        "j2j_same_employer_same_occupation_weighted_rate": [0.0, 1.0, 0.2],
        "j2j_same_employer_different_occupation_weighted_rate": [0.0, 0.05, 0.01],
        "j2j_different_employer_same_occupation_weighted_rate": [0.0, 0.05, 0.01],
        "j2j_different_employer_different_occupation_weighted_rate": [0.0, 0.05, 0.01],
    }
    ...
    for var in [
        ...
        # "j2j_same_employer_same_occupation_rate",
        # "j2j_same_employer_different_occupation_rate",
        # "j2j_different_employer_same_occupation_rate",
        # "j2j_different_employer_different_occupation_rate",
        ...
        "j2j_same_employer_same_occupation_weighted_rate",
        "j2j_same_employer_different_occupation_weighted_rate",
        "j2j_different_employer_same_occupation_weighted_rate",
        "j2j_different_employer_different_occupation_weighted_rate",
    ]:
        # by time
